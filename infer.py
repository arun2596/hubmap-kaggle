...
train_loader, valid_loader = make_loader(df_train, 2, input_shape=(1024,1024), fold=fold)
...
model.load_state_dict(torch.load(os.path.join(MODEL_OUTPUT_DIR, "coat-daformer-smallp-1024", "model"+ str(fold) + ".bin")), strict=True)
