...
if config['scheduler']=='multistep':
    ...
    scheduler = torch.optim.lr_scheduler.OneCycleLR(optimizer, max_lr = 5e-4, epochs=config['epochs'], steps_per_epoch=len(train_loader), pct_start=0.3, anneal_strategy='cos', div_factor=10, final_div_factor=50 ,cycle_momentum=True, base_momentum=0.85, max_momentum=0.95, last_epoch=- 1)
