...
for fold in range(1):
    ...
    if config['scheduler']=='multistep':
        ...
        scheduler = torch.optim.lr_scheduler.OneCycleLR(optimizer, max_lr =[5e-4, 5e-4], total_steps = num_steps, pct_start=0.4, anneal_strategy='cos',  div_factor=20, final_div_factor=25 ,cycle_momentum=True, base_momentum=0.85, max_momentum=0.95, last_epoch=- 1)
